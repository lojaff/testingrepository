...
**TKTK: Describe testingrepository here.**
...
mkvirtualenv testingrepository
...
```
* * * * * ubuntu bash /home/ubuntu/apps/testingrepository/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test 
```
...
|--------|------|-----|-----|--------|--------|
|testingrepository|tweet|`location`||||
|testingrepository|facebook|`location`||||
|testingrepository|email|`location`||||
|testingrepository|new-comment||||
|testingrepository|open-share-discuss||||
|testingrepository|close-share-discuss||||
|testingrepository|summary-copied||||
|testingrepository|featured-tweet-action|`action`||``tweet_url``|
|testingrepository|featured-facebook-action|`action`||``post_url``|
